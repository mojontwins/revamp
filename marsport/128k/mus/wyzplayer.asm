...
PAUTA_0:		DB	13,44,75,8,9,10,9,132
PAUTA_1:		DB	40,73,9,9,40,8,8,7,130
PAUTA_2:		DB	43,9,7,8,8,129
PAUTA_3:		DB	7,8,7,5,129
PAUTA_4:        DB  18,45,75,8,9,10,9,132
PAUTA_5:        DB  19,45,75,8,9,10,9,132
...
TABLA_SONIDOS:  DW      SONIDO1,SONIDO2,SONIDO3 ;,SONIDO3,SONIDO4,SONIDO5,SONIDO6,SONIDO7,SONIDO8, SONIDO9,SONIDO10,SONIDO11
...
TABLA_SONG:     DW      SONG_0, SONG_1, SONG_2, SONG_3, SONG_4 ;, SONG_5, SONG_6, SONG_7, SONG_8          
...
; [0] Astro Ganga (pantalla de título)
SONG_0:         INCBIN "ganga.mus"

; [1] Astro Ganga Intro (Douko Kadeeee)
SONG_1:         INCBIN "ganga_intro.mus"

; [2] Ingame: Moonlite Aliens
SONG_2:         INCBIN "moonlite.mus"

; [3] Game Over
SONG_3:         INCBIN "ganga_gameover.mus"

; [4] Ending: The Duck and the Moon
SONG_4:         INCBIN "quezesto.mus"
