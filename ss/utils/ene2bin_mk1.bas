...
Sub usage
	Print "$ ene2bin_mk1.exe enems.ene enems+hotspots.bin life_gauge [2bytes] [nolife]"
	Print
...
Dim As uByte t, a, b, xx, yy, mn, x, y, s1, s2, xy, life, nolife
...
For i = 1 To mapPants
	For j = 1 To nEnems
		...
		d = t: Put #fOut, , d
		If nolife = 0 Then d = life: Put #fOut, , d
